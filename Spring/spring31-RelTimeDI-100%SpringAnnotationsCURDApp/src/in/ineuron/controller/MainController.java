...
public class MainController {
	...
	public EmployeeVO search(Integer eid) throws Exception {
					
		EmployeeDTO dto = service.search(eid);
		
		EmployeeVO vo = new EmployeeVO();
		vo.seteName(dto.geteName().toString());
		vo.seteAddress(dto.geteAddress().toString());
		vo.setDept(dto.getDept().toString());
		vo.setSalary(dto.getSalary().toString());
