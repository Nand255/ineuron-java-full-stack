...
public class CustomerMySQLDAOImpl implements ICustomerDAO {
	...
	private static final String REALTIMEDI_CUSTOMER_INSERT_QUERY = "insert into customer (cname,caddress,pamt,rate,time,intrAmount) values(?,?,?,?,?,?)";
	private DataSource dataSource;
	
	
	public CustomerMySQLDAOImpl(DataSource dataSource) {
		this.dataSource = dataSource;
		System.out.println("CustomerMySQLDAOImpl :: 1 param constructoer --->"+dataSource.getClass().getName());
	}
